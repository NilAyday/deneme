...
plt.hist(np.array(s['loss']),bins=100,alpha=0.5,label="clean data")
plt.hist(np.array(s_pertub_1['loss']),bins=100,alpha=0.5,label="corrupted data")
plt.legend()
#plt.show()
...
plt.clf()
plt.hist(np.array(s['loss']),bins=100,alpha=0.5,label="clean data")
plt.hist(np.array(s_pertub_2['loss']),bins=100,alpha=0.5,label="corrupted data")
plt.legend()
#plt.show()
