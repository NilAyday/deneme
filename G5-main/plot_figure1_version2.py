...
print(b[0])
print("---")
print([b[x_]['train_acc'] for x_ in range(10)])
plt.plot(x, [b[x_]['train_acc'] for x_ in range(10)], marker='o', label="Train accuracy")
plt.plot(x, [b[x_]['val_acc'] for x_ in range(10)], marker='s', label="Test accuracy")
plt.plot(x, [b[x_]['true_train_acc'] for x_ in range(10)], color='red', marker='v', 
