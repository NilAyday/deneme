...
print(b[0])
print("---")
print([b[x_]['train_acc'] for x_ in x])
plt.plot(x, [b[x_]['train_acc'][0] for x_ in x], marker='o', label="Train accuracy")
plt.plot(x, [b[x_]['val_acc'][0] for x_ in x], marker='s', label="Test accuracy")
plt.plot(x, [b[x_]['true_train_acc'][0] for x_ in x], color='red', marker='v', 
